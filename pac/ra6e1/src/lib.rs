#![doc = "Peripheral access API for R7FA6E10F microcontrollers (generated using svd2rust v0.28.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl SCI2 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const sci2::RegisterBlock = 0x4011_8200 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
