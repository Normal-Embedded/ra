...
This is the Peripheral Access Crate (PAC) for the RA6M4 device series.
...
The `ra6m4` crate provides low-level access to device registers, enabling developers to interact with the hardware safely and efficiently.
