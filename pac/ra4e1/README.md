...
This is the Peripheral Access Crate (PAC) for the RA4E1 device series.
...
The `ra4e1` crate provides low-level access to device registers, enabling developers to interact with the hardware safely and efficiently.
