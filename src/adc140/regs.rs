...
impl defmt::Format for Adads0 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adads0 {{ ads00: {:?}, ads01: {:?}, ads02: {:?}, ads03: {:?}, ads04: {:?}, ads05: {:?}, ads06: {:?}, ads07: {:?}, ads08: {:?}, ads09: {:?}, ads10: {:?}, ads11: {:?}, ads12: {:?}, ads13: {:?}, ads14: {:?}, reserved: {=bool:?} }}" , self . ads00 () , self . ads01 () , self . ads02 () , self . ads03 () , self . ads04 () , self . ads05 () , self . ads06 () , self . ads07 () , self . ads08 () , self . ads09 () , self . ads10 () , self . ads11 () , self . ads12 () , self . ads13 () , self . ads14 () , self . reserved ())
    }
}
...
impl defmt::Format for Adads1 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adads1 {{ ads16: {:?}, ads17: {:?}, ads18: {:?}, ads19: {:?}, ads20: {:?}, ads21: {:?}, ads22: {:?}, ads23: {:?}, ads24: {:?}, ads25: {:?}, reserved: {=u8:?} }}" , self . ads16 () , self . ads17 () , self . ads18 () , self . ads19 () , self . ads20 () , self . ads21 () , self . ads22 () , self . ads23 () , self . ads24 () , self . ads25 () , self . reserved ())
    }
}
...
impl defmt::Format for Adansa0 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adansa0 {{ ansa00: {:?}, ansa01: {:?}, ansa02: {:?}, ansa03: {:?}, ansa04: {:?}, ansa05: {:?}, ansa06: {:?}, ansa07: {:?}, ansa08: {:?}, ansa09: {:?}, ansa010: {:?}, ansa011: {:?}, ansa012: {:?}, ansa013: {:?}, ansa014: {:?}, reserved: {=bool:?} }}" , self . ansa00 () , self . ansa01 () , self . ansa02 () , self . ansa03 () , self . ansa04 () , self . ansa05 () , self . ansa06 () , self . ansa07 () , self . ansa08 () , self . ansa09 () , self . ansa010 () , self . ansa011 () , self . ansa012 () , self . ansa013 () , self . ansa014 () , self . reserved ())
    }
}
...
impl defmt::Format for Adansa1 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adansa1 {{ ansa16: {:?}, ansa17: {:?}, ansa18: {:?}, ansa19: {:?}, ansa20: {:?}, ansa21: {:?}, ansa22: {:?}, ansa23: {:?}, ansa24: {:?}, ansa25: {:?}, reserved: {=u8:?} }}" , self . ansa16 () , self . ansa17 () , self . ansa18 () , self . ansa19 () , self . ansa20 () , self . ansa21 () , self . ansa22 () , self . ansa23 () , self . ansa24 () , self . ansa25 () , self . reserved ())
    }
}
...
impl defmt::Format for Adansb0 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adansb0 {{ ansb00: {:?}, ansb01: {:?}, ansb02: {:?}, ansb03: {:?}, ansb04: {:?}, ansb05: {:?}, ansb06: {:?}, ansb07: {:?}, ansb08: {:?}, ansb09: {:?}, ansb10: {:?}, ansb11: {:?}, ansb12: {:?}, ansb13: {:?}, ansb14: {:?}, reserved: {=bool:?} }}" , self . ansb00 () , self . ansb01 () , self . ansb02 () , self . ansb03 () , self . ansb04 () , self . ansb05 () , self . ansb06 () , self . ansb07 () , self . ansb08 () , self . ansb09 () , self . ansb10 () , self . ansb11 () , self . ansb12 () , self . ansb13 () , self . ansb14 () , self . reserved ())
    }
}
...
impl defmt::Format for Adansb1 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adansb1 {{ ansb16: {:?}, ansb17: {:?}, ansb18: {:?}, ansb19: {:?}, ansb20: {:?}, ansb21: {:?}, ansb22: {:?}, ansb23: {:?}, ansb24: {:?}, ansb25: {:?}, reserved: {=u8:?} }}" , self . ansb16 () , self . ansb17 () , self . ansb18 () , self . ansb19 () , self . ansb20 () , self . ansb21 () , self . ansb22 () , self . ansb23 () , self . ansb24 () , self . ansb25 () , self . reserved ())
    }
}
...
impl defmt::Format for Adcer {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adcer {{ reserved: {=bool:?}, adprc: {:?}, reserved: {=bool:?}, reserved: {=bool:?}, ace: {:?}, reserved: {=u8:?}, diagval: {:?}, diagld: {:?}, diagm: {:?}, reserved: {=u8:?}, adrfmt: {:?} }}" , self . reserved () , self . adprc () , self . reserved () , self . reserved () , self . ace () , self . reserved () , self . diagval () , self . diagld () , self . diagm () , self . reserved () , self . adrfmt ())
    }
}
...
impl defmt::Format for Adcmpansr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adcmpansr1 {{ cmpcha16: {:?}, cmpcha17: {:?}, cmpcha18: {:?}, cmpcha19: {:?}, cmpcha20: {:?}, cmpcha21: {:?}, cmpcha22: {:?}, cmpcha23: {:?}, cmpcha24: {:?}, cmpcha25: {:?}, reserved: {=u8:?} }}" , self . cmpcha16 () , self . cmpcha17 () , self . cmpcha18 () , self . cmpcha19 () , self . cmpcha20 () , self . cmpcha21 () , self . cmpcha22 () , self . cmpcha23 () , self . cmpcha24 () , self . cmpcha25 () , self . reserved ())
    }
}
...
impl defmt::Format for Adcmpcr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adcmpcr {{ cmpab: {:?}, reserved: {=u8:?}, cmpbe: {:?}, reserved: {=bool:?}, cmpae: {:?}, reserved: {=bool:?}, cmpbie: {:?}, wcmpe: {:?}, cmpaie: {:?} }}" , self . cmpab () , self . reserved () , self . cmpbe () , self . reserved () , self . cmpae () , self . reserved () , self . cmpbie () , self . wcmpe () , self . cmpaie ())
    }
}
...
impl defmt::Format for Adcmplr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adcmplr0 {{ cmplcha00: {:?}, cmplcha01: {:?}, cmplcha02: {:?}, cmplcha03: {:?}, cmplcha04: {:?}, cmplcha05: {:?}, cmplcha06: {:?}, cmplcha07: {:?}, cmplcha08: {:?}, cmplcha09: {:?}, cmplcha10: {:?}, cmplcha11: {:?}, cmplcha12: {:?}, cmplcha13: {:?}, cmplcha14: {:?}, reserved: {=bool:?} }}" , self . cmplcha00 () , self . cmplcha01 () , self . cmplcha02 () , self . cmplcha03 () , self . cmplcha04 () , self . cmplcha05 () , self . cmplcha06 () , self . cmplcha07 () , self . cmplcha08 () , self . cmplcha09 () , self . cmplcha10 () , self . cmplcha11 () , self . cmplcha12 () , self . cmplcha13 () , self . cmplcha14 () , self . reserved ())
    }
}
...
impl defmt::Format for Adcmplr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adcmplr1 {{ cmplcha16: {:?}, cmplcha17: {:?}, cmplcha18: {:?}, cmplcha19: {:?}, cmplcha20: {:?}, cmplcha21: {:?}, cmplcha22: {:?}, cmplcha23: {:?}, cmplcha24: {:?}, cmplcha25: {:?}, reserved: {=u8:?} }}" , self . cmplcha16 () , self . cmplcha17 () , self . cmplcha18 () , self . cmplcha19 () , self . cmplcha20 () , self . cmplcha21 () , self . cmplcha22 () , self . cmplcha23 () , self . cmplcha24 () , self . cmplcha25 () , self . reserved ())
    }
}
...
impl defmt::Format for Adcmpsr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adcmpsr1 {{ cmpstcha16: {:?}, cmpstcha17: {:?}, cmpstcha18: {:?}, cmpstcha19: {:?}, cmpstcha20: {:?}, cmpstcha21: {:?}, cmpstcha22: {:?}, cmpstcha23: {:?}, cmpstcha24: {:?}, cmpstcha25: {:?}, reserved: {=u8:?} }}" , self . cmpstcha16 () , self . cmpstcha17 () , self . cmpstcha18 () , self . cmpstcha19 () , self . cmpstcha20 () , self . cmpstcha21 () , self . cmpstcha22 () , self . cmpstcha23 () , self . cmpstcha24 () , self . cmpstcha25 () , self . reserved ())
    }
}
...
impl defmt::Format for Adcsr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adcsr {{ dblans: {=u8:?}, reserved: {=bool:?}, gbadie: {:?}, dble: {:?}, extrg: {:?}, trge: {:?}, adhsc: {:?}, reserved: {=u8:?}, adcs: {:?}, adst: {:?} }}" , self . dblans () , self . reserved () , self . gbadie () , self . dble () , self . extrg () , self . trge () , self . adhsc () , self . reserved () , self . adcs () , self . adst ())
    }
}
...
impl defmt::Format for Adexicr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adexicr {{ tssad: {:?}, ocsad: {:?}, reserved: {=u8:?}, tssa: {:?}, ocsa: {:?}, reserved: {=bool:?}, reserved: {=bool:?}, reserved: {=bool:?}, reserved: {=bool:?}, reserved: {=bool:?} }}" , self . tssad () , self . ocsad () , self . reserved () , self . tssa () , self . ocsa () , self . reserved () , self . reserved () , self . reserved () , self . reserved () , self . reserved ())
    }
}
...
impl defmt::Format for Adgspcr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adgspcr {{ pgs: {:?}, gbrscn: {:?}, reserved: {=u8:?}, reserved: {=bool:?}, reserved: {=u8:?}, gbrp: {:?} }}" , self . pgs () , self . gbrscn () , self . reserved () , self . reserved () , self . reserved () , self . gbrp ())
    }
}
...
impl defmt::Format for Adhvrefcnt {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adhvrefcnt {{ hvsel: {:?}, lvsel: {:?}, reserved: {=u8:?}, reserved: {=u8:?}, adslp: {:?} }}" , self . hvsel () , self . lvsel () , self . reserved () , self . reserved () , self . adslp ())
    }
}
...
impl defmt::Format for Adstrgr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Adstrgr {{ trsb: {=u8:?}, reserved: {=u8:?}, trsa: {=u8:?}, reserved: {=u8:?} }}",
            self.trsb(),
            self.reserved(),
            self.trsa(),
            self.reserved()
...
impl defmt::Format for Adwinmon {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Adwinmon {{ moncomb: {:?}, reserved: {=u8:?}, moncmpa: {:?}, moncmpb: {:?}, reserved: {=u8:?} }}" , self . moncomb () , self . reserved () , self . moncmpa () , self . moncmpb () , self . reserved ())
    }
}
