...
impl Icwur {
    ...
    #[doc = "Wakeup Analog Filter Additional Selection"]
    #[inline(always)]
    pub const fn set_wuafa(&mut self, val: super::vals::Wuafa) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u8) & 0x01) << 0usize);
    }
    ...
    #[doc = "ACK bit for Wakeup Mode"]
    #[inline(always)]
    pub const fn set_wuack(&mut self, val: super::vals::Wuack) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u8) & 0x01) << 4usize);
    }
    ...
    #[doc = "Wakeup Event Occurrence Flag"]
    #[inline(always)]
    pub const fn set_wuf(&mut self, val: super::vals::Wuf) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u8) & 0x01) << 5usize);
    }
    ...
    #[doc = "Wakeup Interrupt Request Enable"]
    #[inline(always)]
    pub const fn set_wuie(&mut self, val: super::vals::Wuie) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u8) & 0x01) << 6usize);
    }
    ...
    #[doc = "Wakeup Function Enable"]
    #[inline(always)]
    pub const fn set_wue(&mut self, val: super::vals::Wue) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u8) & 0x01) << 7usize);
    }
}
...
impl defmt::Format for Icwur {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Icwur {{ wuafa: {:?}, wuack: {:?}, wuf: {:?}, wuie: {:?}, wue: {:?} }}",
            self.wuafa(),
            self.wuack(),
            self.wuf(),
            self.wuie(),
...
impl Icwur2 {
    ...
    #[doc = "Wake-up Function Synchronous Enable"]
    #[inline(always)]
    pub const fn set_wusen(&mut self, val: super::vals::Wusen) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u8) & 0x01) << 0usize);
    }
    ...
    #[doc = "Wake-up Function Asynchronous Operation Status Flag"]
    #[inline(always)]
    pub const fn set_wuasyf(&mut self, val: super::vals::Wuasyf) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u8) & 0x01) << 1usize);
    }
    ...
    #[doc = "Wake-up Function Synchronous Operation Status Flag"]
    #[inline(always)]
    pub const fn set_wusyf(&mut self, val: super::vals::Wusyf) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u8) & 0x01) << 2usize);
    }
}
